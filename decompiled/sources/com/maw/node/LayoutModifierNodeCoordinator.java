...
public final class LayoutModifierNodeCoordinator extends NodeCoordinator {
    ...
    private final class LookaheadDelegateForLayoutModifierNode extends LookaheadDelegate {
        ...
        public Placeable mo4677measureBRTryo0(long constraints) {
            ...
            layoutModifierNodeCoordinator.lookaheadConstraints = Constraints.m5677boximpl(constraints);
    ...
    /* JADX INFO: renamed from: measure-BRTryo0 */
    public Placeable mo4677measureBRTryo0(long constraints) {
        MeasureResult measureResultMo90measure3p2s80s;
        ...
        if ($this$measure_BRTryo0_u24lambda_u242_u24lambda_u241 instanceof IntermediateLayoutModifierNode) {
            ...
            measureResultMo90measure3p2s80s = ((IntermediateLayoutModifierNode) $this$measure_BRTryo0_u24lambda_u242_u24lambda_u241).m4679intermediateMeasureTeuZzU(this, wrappedNonNull, constraints, jIntSize, constraints2.getValue());
        } else {
            measureResultMo90measure3p2s80s = $this$measure_BRTryo0_u24lambda_u242_u24lambda_u241.mo90measure3p2s80s(this, getWrappedNonNull(), constraints);
        }
        setMeasureResult$ui_release(measureResultMo90measure3p2s80s);
        onMeasured();
        return this;
    }
    ...
    static {
        ...
        paint.mo3285setColor8_81llA(Color.INSTANCE.m3433getBlue0d7_KjU());
