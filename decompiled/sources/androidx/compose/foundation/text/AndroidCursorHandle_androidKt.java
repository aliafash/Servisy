...
public final class AndroidCursorHandle_androidKt {
    private static final float CursorHandleHeight = Dp.m5733constructorimpl(25);
    private static final float CursorHandleWidth;
    private static final float Sqrt2 = 1.4142135f;

    static {
        float arg0$iv = CursorHandleHeight;
        CursorHandleWidth = Dp.m5733constructorimpl(Dp.m5733constructorimpl(arg0$iv * 2.0f) / 2.4142137f);
    }
    ...
    public static final void m834CursorHandleULxng0E(final long handlePosition, final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer $composer, final int $changed) {
        Object value$iv;
        ...
        if (($dirty & 731) != 146 || !$composer2.getSkipping()) {
            ...
            $composer2.startReplaceableGroup(2068318109);
        ...
        if (scopeUpdateScopeEndRestartGroup != null) {
            scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$CursorHandle$3
                ...
                public final void invoke(Composer composer, int i) {
                    AndroidCursorHandle_androidKt.m834CursorHandleULxng0E(handlePosition, modifier, function2, composer, RecomposeScopeImplKt.updateChangedFlags($changed | 1));
                }
            });
        }
    }
                ...
                if (invalid$iv || it$iv == Composer.INSTANCE.getEmpty()) {
                    value$iv = new Function1<CacheDrawScope, DrawResult>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1
                        ...
                        public final DrawResult invoke(CacheDrawScope $this$drawWithCache) {
                            final float radius = Size.m3234getWidthimpl($this$drawWithCache.m3072getSizeNHjbRc()) / 2.0f;
                            ...
                            return $this$drawWithCache.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.text.AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1.1
                                ...
                                public final void invoke2(ContentDrawScope $this$onDrawWithContent) {
                                    ...
                                    long previousSize$iv = $this$withTransform_u24lambda_u246$iv.mo3881getSizeNHjbRc();
                                    ...
                                    $this$invoke_u24lambda_u240.mo3887rotateUv8p0NA(45.0f, Offset.INSTANCE.m3181getZeroF1C5BW0());
                                    DrawScope.m3941drawImagegbVJVH8$default($this$withTransform$iv, imageBitmap2, 0L, 0.0f, null, colorFilter2, 0, 46, null);
                                    $this$withTransform_u24lambda_u246$iv.getCanvas().restore();
                                    $this$withTransform_u24lambda_u246$iv.mo3882setSizeuvyYCjk(previousSize$iv);
                                }
                            });
                        }
                    };
