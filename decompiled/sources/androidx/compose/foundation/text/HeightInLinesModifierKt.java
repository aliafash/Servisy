        ...
        return ComposedModifierKt.composed($this$heightInLines, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.text.HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
                ...
                if (invalid$iv || it$iv$iv3 == Composer.INSTANCE.getEmpty()) {
                    value$iv$iv3 = Integer.valueOf(IntSize.m5902getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(resolvedStyle, density, fontFamilyResolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
                ...
                if (invalid$iv2 || it$iv$iv4 == Composer.INSTANCE.getEmpty()) {
                    ...
                    value$iv$iv4 = Integer.valueOf(IntSize.m5902getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(resolvedStyle, density, fontFamilyResolver, twoLines, 2)));
                ...
                Modifier modifierM598heightInVpY3zN4 = SizeKt.m598heightInVpY3zN4(Modifier.INSTANCE, precomputedMinLinesHeight != null ? density.mo310toDpu2uoSUM(precomputedMinLinesHeight.intValue()) : Dp.INSTANCE.m5753getUnspecifiedD9Ej5fM(), precomputedMaxLinesHeight != null ? density.mo310toDpu2uoSUM(precomputedMaxLinesHeight.intValue()) : Dp.INSTANCE.m5753getUnspecifiedD9Ej5fM());
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer.endReplaceableGroup();
                return modifierM598heightInVpY3zN4;
            }
        });
    }
