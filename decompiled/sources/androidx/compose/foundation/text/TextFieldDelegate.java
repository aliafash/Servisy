...
public final class TextFieldDelegate {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ Triple m908layout_EkL_Y$foundation_release$default(Companion companion, TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
            ...
            return companion.m910layout_EkL_Y$foundation_release(textDelegate, j, layoutDirection, textLayoutResult2);
        }

        @JvmStatic
        /* JADX INFO: renamed from: layout-_EkL_-Y$foundation_release, reason: not valid java name */
        public final Triple<Integer, Integer, TextLayoutResult> m910layout_EkL_Y$foundation_release(TextDelegate textDelegate, long constraints, LayoutDirection layoutDirection, TextLayoutResult prevResultText) {
            TextLayoutResult layoutResult = textDelegate.m900layoutNN6EwU(constraints, layoutDirection, prevResultText);
            return new Triple<>(Integer.valueOf(IntSize.m5903getWidthimpl(layoutResult.getSize())), Integer.valueOf(IntSize.m5902getHeightimpl(layoutResult.getSize())), layoutResult);
        }
        ...
        public final void draw$foundation_release(Canvas canvas, TextFieldValue value, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Paint selectionPaint) {
            int start;
            int end;
            if (!TextRange.m5226getCollapsedimpl(value.getSelection()) && (start = offsetMapping.originalToTransformed(TextRange.m5230getMinimpl(value.getSelection()))) != (end = offsetMapping.originalToTransformed(TextRange.m5229getMaximpl(value.getSelection())))) {
        ...
        public final void notifyFocusedRect$foundation_release(TextFieldValue value, TextDelegate textDelegate, TextLayoutResult textLayoutResult, LayoutCoordinates layoutCoordinates, TextInputSession textInputSession, boolean hasFocus, OffsetMapping offsetMapping) {
            ...
            int focusOffsetInTransformed = offsetMapping.originalToTransformed(TextRange.m5229getMaximpl(value.getSelection()));
            if (focusOffsetInTransformed < textLayoutResult.getLayoutInput().getText().length()) {
                ...
                bbox = new Rect(0.0f, 0.0f, 1.0f, IntSize.m5902getHeightimpl(defaultSize));
            }
            long globalLT = layoutCoordinates.mo4686localToRootMKHz9U(OffsetKt.Offset(bbox.getLeft(), bbox.getTop()));
            textInputSession.notifyFocusedRect(RectKt.m3205Recttz77jQw(OffsetKt.Offset(Offset.m3165getXimpl(globalLT), Offset.m3166getYimpl(globalLT)), SizeKt.Size(bbox.getWidth(), bbox.getHeight())));
        }
            ...
            if (innerTextFieldCoordinates != null && innerTextFieldCoordinates.isAttached() && (decorationBoxCoordinates = textLayoutResult.getDecorationBoxCoordinates()) != null) {
                textInputSession.updateTextLayoutResult(textFieldValue, offsetMapping, textLayoutResult.getValue(), new Function1<Matrix, Unit>() { // from class: androidx.compose.foundation.text.TextFieldDelegate$Companion$updateTextLayoutResult$1$1$1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Matrix matrix) {
                        m912invoke58bKbWc(matrix.m3659unboximpl());
                        return Unit.INSTANCE;
                    }

                    /* JADX INFO: renamed from: invoke-58bKbWc, reason: not valid java name */
                    public final void m912invoke58bKbWc(float[] matrix) {
                        LayoutCoordinatesKt.findRootCoordinates(innerTextFieldCoordinates).mo4688transformFromEL8BTi8(innerTextFieldCoordinates, matrix);
                    }
        ...
        public final void m911setCursorOffsetULxng0E$foundation_release(long position, TextLayoutResultProxy textLayoutResult, EditProcessor editProcessor, OffsetMapping offsetMapping, Function1<? super TextFieldValue, Unit> onValueChange) {
            int offset = offsetMapping.transformedToOriginal(TextLayoutResultProxy.m936getOffsetForPosition3MmeM6k$default(textLayoutResult, position, false, 2, null));
            onValueChange.invoke(TextFieldValue.m5465copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, TextRangeKt.TextRange(offset), (TextRange) null, 5, (Object) null));
        }
        ...
        public final void onBlur$foundation_release(TextInputSession textInputSession, EditProcessor editProcessor, Function1<? super TextFieldValue, Unit> onValueChange) {
            onValueChange.invoke(TextFieldValue.m5465copy3r_uNRQ$default(editProcessor.toTextFieldValue(), (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null));
            textInputSession.dispose();
        }

        /* JADX INFO: renamed from: applyCompositionDecoration-72CqOWE, reason: not valid java name */
        public final TransformedText m909applyCompositionDecoration72CqOWE(long compositionRange, TransformedText transformed) {
            int startPositionTransformed = transformed.getOffsetMapping().originalToTransformed(TextRange.m5232getStartimpl(compositionRange));
            int endPositionTransformed = transformed.getOffsetMapping().originalToTransformed(TextRange.m5227getEndimpl(compositionRange));
