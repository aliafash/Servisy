        ...
        return enabled ? ComposedModifierKt.composed$default($this$tapPressTextFieldModifier, null, new Function3<Modifier, Composer, Integer, Modifier>() { // from class: androidx.compose.foundation.text.TextFieldPressGestureFilterKt.tapPressTextFieldModifier.1
            ...
            static final class AnonymousClass2 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
                ...
                public final Object invokeSuspend(Object $result) {
                    ...
                    switch (this.label) {
                        case 0:
                            ...
                            C00491 c00491 = new C00491(this.$scope, this.$pressedInteraction, this.$interactionSource, null);
                            final State<Function1<Offset, Unit>> state = this.$onTapState;
                            this.label = 1;
                            if (TapGestureDetectorKt.detectTapAndPress($this$pointerInput, c00491, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.TextFieldPressGestureFilterKt.tapPressTextFieldModifier.1.2.2
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                /* JADX WARN: Multi-variable type inference failed */
                                {
                                    super(1);
                                ...
                                public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                                    m923invokek4lQ0M(offset.getPackedValue());
                                    return Unit.INSTANCE;
                                }

                                /* JADX INFO: renamed from: invoke-k-4lQ0M, reason: not valid java name */
                                public final void m923invokek4lQ0M(long it) {
                                    state.getValue().invoke(Offset.m3154boximpl(it));
                                }
                ...
                static final class C00491 extends SuspendLambda implements Function3<PressGestureScope, Offset, Continuation<? super Unit>, Object> {
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    C00491(CoroutineScope coroutineScope, MutableState<PressInteraction.Press> mutableState, MutableInteractionSource mutableInteractionSource, Continuation<? super C00491> continuation) {
                    ...
                    public /* bridge */ /* synthetic */ Object invoke(PressGestureScope pressGestureScope, Offset offset, Continuation<? super Unit> continuation) {
                        return m922invoked4ec7I(pressGestureScope, offset.getPackedValue(), continuation);
                    }

                    /* JADX INFO: renamed from: invoke-d-4ec7I, reason: not valid java name */
                    public final Object m922invoked4ec7I(PressGestureScope pressGestureScope, long j, Continuation<? super Unit> continuation) {
                        C00491 c00491 = new C00491(this.$scope, this.$pressedInteraction, this.$interactionSource, continuation);
                        c00491.L$0 = pressGestureScope;
                        c00491.J$0 = j;
                        ...
                        */
                        public final java.lang.Object invokeSuspend(java.lang.Object r10) {
                            ...
                            L7c:
                                ...
                                return r0
                            */
                            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.text.TextFieldPressGestureFilterKt.AnonymousClass1.AnonymousClass2.C00491.C00501.invokeSuspend(java.lang.Object):java.lang.Object");
                        }
                    }
                    ...
                    public final Object invokeSuspend(Object $result) {
                        ...
                        switch (this.label) {
                            case 0:
                                ResultKt.throwOnFailure($result);
                                c00491 = this;
                                PressGestureScope $this$detectTapAndPress = (PressGestureScope) c00491.L$0;
                                long it = c00491.J$0;
                                BuildersKt__Builders_commonKt.launch$default(c00491.$scope, null, null, new C00501(c00491.$pressedInteraction, it, c00491.$interactionSource, null), 3, null);
                                c00491.label = 1;
                                Object objTryAwaitRelease = $this$detectTapAndPress.tryAwaitRelease(c00491);
                        ...
                        BuildersKt__Builders_commonKt.launch$default(c00491.$scope, null, null, new C00512(c00491.$pressedInteraction, success, c00491.$interactionSource, null), 3, null);
                        return Unit.INSTANCE;
                    }
                    ...
                    static final class C00512 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                        ...
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        C00512(MutableState<PressInteraction.Press> mutableState, boolean z, MutableInteractionSource mutableInteractionSource, Continuation<? super C00512> continuation) {
                            super(2, continuation);
                            this.$pressedInteraction = mutableState;
                            this.$success = z;
                            this.$interactionSource = mutableInteractionSource;
                        ...
                        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                            return new C00512(this.$pressedInteraction, this.$success, this.$interactionSource, continuation);
                        }
                        ...
                        public final Object invokeSuspend(Object $result) {
                            ...
                            switch (this.label) {
                                ...
                                case 1:
                                    c00512 = this;
                                    c005122 = null;
                                    mutableState2 = (MutableState) c00512.L$0;
                                    ResultKt.throwOnFailure($result);
                                    mutableState = mutableState2;
                                    mutableState.setValue(null);
                                    return Unit.INSTANCE;
