...
public final class ScrollKt {
    public static final ScrollState rememberScrollState(final int initial, Composer $composer, int $changed, int i) {
        ...
        ScrollState scrollState = (ScrollState) RememberSaveableKt.m3023rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) value$iv, $composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
    ...
    private static final Modifier scroll(Modifier $this$scroll, final ScrollState state, final boolean reverseScrolling, final FlingBehavior flingBehavior, final boolean isScrollable, final boolean isVertical) {
        return ComposedModifierKt.composed($this$scroll, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.ScrollKt$scroll$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier $this$composed, Composer $composer, int $changed) {
                        ...
                        if (z3) {
                            ...
                            SemanticsPropertiesKt.scrollBy$default($this$semantics, null, new Function2<Float, Float, Boolean>() { // from class: androidx.compose.foundation.ScrollKt$scroll$2$semantics$1.1
                                ...
                                static final class C00141 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                                    ...
                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                    C00141(boolean z, ScrollState scrollState, float f, float f2, Continuation<? super C00141> continuation) {
                                    ...
                                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                                        return new C00141(this.$isVertical, this.$state, this.$y, this.$x, continuation);
                                    }
                                ...
                                public final Boolean invoke(float x, float y) {
                                    BuildersKt__Builders_commonKt.launch$default(coroutineScope2, null, null, new C00141(z4, scrollState4, y, x, null), 3, null);
                                    return true;
                                }
                            }, 1, null);
                        }
                ...
                Modifier scrolling = ScrollableKt.scrollable$default(companion2, state, orientation, overscrollEffect, isScrollable, scrollableDefaults.reverseDirection((LayoutDirection) objConsume, orientation, reverseScrolling), flingBehavior, state.getInternalInteractionSource(), null, 128, null);
