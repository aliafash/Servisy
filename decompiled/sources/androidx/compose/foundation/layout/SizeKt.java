...
public final class SizeKt {
    ...
    public static final Modifier m616width3ABfNKs(Modifier $this$width_u2d3ABfNKs, final float width) {
        return $this$width_u2d3ABfNKs.then(new SizeElement(width, 0.0f, width, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$width-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Dp.m5731boximpl(width));
            }
    ...
    public static final Modifier m597height3ABfNKs(Modifier $this$height_u2d3ABfNKs, final float height) {
        return $this$height_u2d3ABfNKs.then(new SizeElement(0.0f, height, 0.0f, height, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$height-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Dp.m5731boximpl(height));
            }
    ...
    public static final Modifier m611size3ABfNKs(Modifier $this$size_u2d3ABfNKs, final float size) {
        return $this$size_u2d3ABfNKs.then(new SizeElement(size, size, size, size, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-3ABfNKs$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.setValue(Dp.m5731boximpl(size));
            }
    ...
    public static final Modifier m613sizeVpY3zN4(Modifier $this$size_u2dVpY3zN4, final float width, final float height) {
        return $this$size_u2dVpY3zN4.then(new SizeElement(width, height, width, height, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$size-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                $this$null.setName("size");
                $this$null.getProperties().set("width", Dp.m5731boximpl(width));
                $this$null.getProperties().set("height", Dp.m5731boximpl(height));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }
    ...
    public static final Modifier m612size6HolHcs(Modifier $this$size_u2d6HolHcs, long size) {
        return m613sizeVpY3zN4($this$size_u2d6HolHcs, DpSize.m5831getWidthD9Ej5fM(size), DpSize.m5829getHeightD9Ej5fM(size));
    }
    ...
    public static /* synthetic */ Modifier m618widthInVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.INSTANCE.m5753getUnspecifiedD9Ej5fM();
        }
        if ((i & 2) != 0) {
            f2 = Dp.INSTANCE.m5753getUnspecifiedD9Ej5fM();
        }
    ...
    public static final Modifier m617widthInVpY3zN4(Modifier $this$widthIn_u2dVpY3zN4, final float min, final float max) {
        return $this$widthIn_u2dVpY3zN4.then(new SizeElement(min, 0.0f, max, 0.0f, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$widthIn-VpY3zN4$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.getProperties().set("min", Dp.m5731boximpl(min));
                $this$null.getProperties().set("max", Dp.m5731boximpl(max));
            }
        } : InspectableValueKt.getNoInspectorInfo(), 10, null));
    }
    ...
    public static /* synthetic */ Modifier m615sizeInqDBjuR0$default(Modifier modifier, float f, float f2, float f3, float f4, int i, Object obj) {
        ...
        if ((i & 4) != 0) {
            f3 = Dp.INSTANCE.m5753getUnspecifiedD9Ej5fM();
        }
        if ((i & 8) != 0) {
            f4 = Dp.INSTANCE.m5753getUnspecifiedD9Ej5fM();
        }
    ...
    public static final Modifier m614sizeInqDBjuR0(Modifier $this$sizeIn_u2dqDBjuR0, final float minWidth, final float minHeight, final float maxWidth, final float maxHeight) {
        return $this$sizeIn_u2dqDBjuR0.then(new SizeElement(minWidth, minHeight, maxWidth, maxHeight, true, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.SizeKt$sizeIn-qDBjuR0$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(InspectorInfo $this$null) {
                ...
                $this$null.getProperties().set("minWidth", Dp.m5731boximpl(minWidth));
                $this$null.getProperties().set("minHeight", Dp.m5731boximpl(minHeight));
                $this$null.getProperties().set("maxWidth", Dp.m5731boximpl(maxWidth));
                $this$null.getProperties().set("maxHeight", Dp.m5731boximpl(maxHeight));
            }
        } : InspectableValueKt.getNoInspectorInfo(), null));
    }
    ...
    public static final Modifier m604requiredSize6HolHcs(Modifier $this$requiredSize_u2d6HolHcs, long size) {
        return m605requiredSizeVpY3zN4($this$requiredSize_u2d6HolHcs, DpSize.m5831getWidthD9Ej5fM(size), DpSize.m5829getHeightD9Ej5fM(size));
    }
