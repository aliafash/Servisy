...
public final class MergeTypeKt {
    ...
    public static final ImageVector getMergeType(Icons.Filled $this$MergeType) {
        ...
        ImageVector.Builder $this$_get_MergeType__u24lambda_u241 = new ImageVector.Builder("Filled.MergeType", Dp.m5733constructorimpl(24.0f), Dp.m5733constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 96, null);
        ...
        $this$PathData_u24lambda_u240$iv$iv$iv.close();
        _mergeType = ImageVector.Builder.m4040addPathoIyEayM$default($this$_get_MergeType__u24lambda_u241, $this$PathData_u24lambda_u240$iv$iv$iv.getNodes(), pathFillType$iv, "", fill$iv$iv, 1.0f, null, 1.0f, 1.0f, strokeLineCap$iv$iv, strokeLineJoin$iv$iv, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
