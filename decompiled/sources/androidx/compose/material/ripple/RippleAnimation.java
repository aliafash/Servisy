...
public final class RippleAnimation {
    ...
    @DebugMetadata(c = "androidx.compose.material.ripple.RippleAnimation", f = "RippleAnimation.kt", i = {0, 1}, l = {GrpcUtil.DEFAULT_PORT_PLAINTEXT, 82, 83}, m = "animate", n = {"this", "this"}, s = {"L$0", "L$0"})
    ...
    */
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            switch (this.label) {
                case 0:
                    ...
                    BuildersKt__Builders_commonKt.launch$default($this$coroutineScope, null, null, new C00812(RippleAnimation.this, null), 3, null);
        ...
        static final class C00812 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
            int label;
            final /* synthetic */ RippleAnimation this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C00812(RippleAnimation rippleAnimation, Continuation<? super C00812> continuation) {
                super(2, continuation);
                this.this$0 = rippleAnimation;
            }
        ...
        /* JADX INFO: compiled from: RippleAnimation.kt */
        @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, k = 3, mv = {1, 8, 0}, xi = 48)
        @DebugMetadata(c = "androidx.compose.material.ripple.RippleAnimation$fadeIn$2$3", f = "RippleAnimation.kt", i = {}, l = {Endpoint.TARGET_FIELD_NUMBER}, m = "invokeSuspend", n = {}, s = {})
    ...
    static final class C03912 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Job>, Object> {
        private /* synthetic */ Object L$0;
        int label;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C03912 c03912 = RippleAnimation.this.new C03912(continuation);
            c03912.L$0 = obj;
            return c03912;
        }
    ...
    public final Object fadeOut(Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C03912(null), continuation);
        return objCoroutineScope == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCoroutineScope : Unit.INSTANCE;
    }
    ...
    public final void m1206draw4WTKRHQ(DrawScope $this$draw_u2d4WTKRHQ, long color) {
        if (this.startRadius == null) {
            this.startRadius = Float.valueOf(RippleAnimationKt.m1208getRippleStartRadiusuvyYCjk($this$draw_u2d4WTKRHQ.mo3956getSizeNHjbRc()));
        }
        if (this.targetRadius == null) {
            float $this$isUnspecified$iv = this.radius;
            this.targetRadius = Float.isNaN($this$isUnspecified$iv) ? Float.valueOf(RippleAnimationKt.m1207getRippleEndRadiuscSwnlzA($this$draw_u2d4WTKRHQ, this.bounded, $this$draw_u2d4WTKRHQ.mo3956getSizeNHjbRc())) : Float.valueOf($this$draw_u2d4WTKRHQ.mo313toPx0680j_4(this.radius));
        }
        if (this.origin == null) {
            this.origin = Offset.m3154boximpl($this$draw_u2d4WTKRHQ.mo3955getCenterF1C5BW0());
        }
        if (this.targetCenter == null) {
            this.targetCenter = Offset.m3154boximpl(OffsetKt.Offset(Size.m3234getWidthimpl($this$draw_u2d4WTKRHQ.mo3956getSizeNHjbRc()) / 2.0f, Size.m3231getHeightimpl($this$draw_u2d4WTKRHQ.mo3956getSizeNHjbRc()) / 2.0f));
        }
        ...
        float fM3165getXimpl = Offset.m3165getXimpl(offset.getPackedValue());
        Offset offset2 = this.targetCenter;
        Intrinsics.checkNotNull(offset2);
        float fLerp = MathHelpersKt.lerp(fM3165getXimpl, Offset.m3165getXimpl(offset2.getPackedValue()), this.animatedCenterPercent.getValue().floatValue());
        Offset offset3 = this.origin;
        Intrinsics.checkNotNull(offset3);
        float fM3166getYimpl = Offset.m3166getYimpl(offset3.getPackedValue());
        Offset offset4 = this.targetCenter;
        Intrinsics.checkNotNull(offset4);
        long centerOffset = OffsetKt.Offset(fLerp, MathHelpersKt.lerp(fM3166getYimpl, Offset.m3166getYimpl(offset4.getPackedValue()), this.animatedCenterPercent.getValue().floatValue()));
        long modulatedColor = Color.m3404copywmQWz5c(color, (14 & 1) != 0 ? Color.m3408getAlphaimpl(color) : Color.m3408getAlphaimpl(color) * alpha, (14 & 2) != 0 ? Color.m3412getRedimpl(color) : 0.0f, (14 & 4) != 0 ? Color.m3411getGreenimpl(color) : 0.0f, (14 & 8) != 0 ? Color.m3409getBlueimpl(color) : 0.0f);
        if (!this.bounded) {
            DrawScope.m3938drawCircleVaOC9Bg$default($this$draw_u2d4WTKRHQ, modulatedColor, radius, centerOffset, 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
            return;
        }
        float right$iv = Size.m3234getWidthimpl($this$draw_u2d4WTKRHQ.mo3956getSizeNHjbRc());
        float bottom$iv = Size.m3231getHeightimpl($this$draw_u2d4WTKRHQ.mo3956getSizeNHjbRc());
        int clipOp$iv = ClipOp.INSTANCE.m3395getIntersectrtfAjoo();
        ...
        $this$clipRect_rOu3jXo_u24lambda_u244$iv.mo3884clipRectN_I0leg(0.0f, 0.0f, right$iv, bottom$iv, clipOp$iv);
        DrawScope.m3938drawCircleVaOC9Bg$default($this$draw_u2d4WTKRHQ, modulatedColor, radius, centerOffset, 0.0f, null, null, 0, MenuKt.InTransitionDuration, null);
